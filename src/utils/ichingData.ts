export interface IchingHexagram {
  judgment: string; // 卦辞
  yaos: string[];    // 6 lines: 0=初爻, 1=二爻, 2=三爻, 3=四爻, 4=五爻, 5=上爻
}

export const ICHING_DATA: Record<string, IchingHexagram> = {
  "乾为天": {
    judgment: "元、亨、利、贞。",
    yaos: [
      "初九：潜龙，勿用。",
  ...
  "坤为地": {
    judgment: "元，亨，利牝马之贞。君子有攸往，先迷后得主，利；西南得朋，东北丧朋。安贞吉。",
    yaos: [
      "初六：履霜，坚冰至。",
      "六二：直、方、大，不习无不利。",
      "六三：含章可贞。或从王事，无成有终。",
  ...
  "水风井": {
    judgment: "改邑不改井，无丧无得，往来井井。汔至，亦未繘井，赢其瓶，凶。",
    yaos: [
      "初六：井泥不食，旧井无禽。",
      "九二：井谷射鲋，瓮敝漏。",
